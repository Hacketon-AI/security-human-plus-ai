...
export function CredentialStateCard({
  ...
  return (
    <div className={cn("ss-panel", className)}>
      <div className="flex items-center justify-between px-4 py-2.5 border-b border-[var(--ss-hairline-strong)]">
...
export function KillSwitchControl({
  ...
  const tone =
    state === "active"
      ...
      : { border: "border-[var(--ss-hairline-strong)]", bg: "bg-transparent", glow: "", text: "text-slate-300", Icon: Lock };
        ...
        <div className="flex items-center gap-2 pt-1">
          {state === "inactive" ? (
            ...
            <>
              ...
              <button
                onClick={onDisarm}
                className="inline-flex items-center gap-1.5 px-3 py-1.5 text-[11px] font-medium uppercase tracking-wider rounded-sm border border-[var(--ss-hairline-strong)] bg-[var(--ss-surface-3)] text-slate-300 hover:bg-[var(--ss-surface-4)] transition-all"
              >
